...
try {
    ...
    $response | ConvertTo-Json -Depth 10 | Out-File "C:\Users\usuario\Downloads\controle-ronda-temp\test_daily_result.txt" -Encoding utf8
} catch {
    $result = @{
    ...
    $result | ConvertTo-Json -Depth 10 | Out-File "C:\Users\usuario\Downloads\controle-ronda-temp\test_daily_result.txt" -Encoding utf8
}
