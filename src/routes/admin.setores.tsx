...
function Setores() {
  ...
  return (
      ...
      <form onSubmit={criar} className="flex gap-2">
        ...
        <Button
          type="submit"
          className="bg-primary text-primary-foreground hover:shadow-[0_0_16px_rgba(0,240,255,0.25)]"
        >
        ...
        {loading ? (
          ...
          <ul className="divide-y divide-subtle">
            {items.map((s) => (
              <li
                key={s.id}
                className="flex items-center justify-between px-4 py-3 hover:bg-hover-subtle transition-colors"
              >
